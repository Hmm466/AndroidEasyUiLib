package com.yzp.easyui.taodetails.RefresView;
...
public class PullToRefreshViewUpDown extends LinearLayout {
...
//  private String mLastUpdateTime;
	...
	public PullToRefreshViewUpDown(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public PullToRefreshViewUpDown(Context context) {
		super(context);
		init();
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		switch (event.getAction()) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				if (isboolean == false){
					//deltaY>0   向上运动 deltaY<0 向下运动
					//下拉操作
					if (mPullState == PULL_DOWN_STATE) {
						headerPrepareToRefresh(deltaY);//---注释了
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderImageView.setImageResource(R.mipmap.down);
		mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
	...
	public void onFooterRefreshComplete() {
		...
		mFooterImageView.setImageResource(R.mipmap.up);
		mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
